...
module.exports = class Nuevo {

    //Constructor de la clase. Sirve para crear un nuevo objeto, y en él se definen las propiedades del modelo
    constructor(nuevo_nuevo) {
        this.nombre = nuevo_nuevo.nombre || 'Polimá Westcoast';
        this.imagen = nuevo_nuevo.imagen || 'https://bulma.io/images/placeholders/1280x960.png';
        this.descripcion = nuevo_nuevo.descripcion || 'Un ritmo que reventará el género';
    }

    //Este método servirá para guardar de manera persistente el nuevo objeto. 
    save() {
        artistasNuevos.push(this);
    }
